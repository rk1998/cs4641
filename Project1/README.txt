...
To run the code with the student data set use. Change the last argument to ‘wine’ to run it on the wine dataset.

python decisiontrees.py student

For the SVM, you add either ‘rbf’ or ‘poly’ to see how it works with the different kernel functions
